...
typedef struct __mavlink_param_ext_request_read_t {
 int16_t param_index; /*<  Parameter index, or -1 to use param_id.*/
 uint8_t target_system; /*<  System ID.*/
 uint8_t target_component; /*<  Component ID.*/
 char param_id[16]; /*<  Parameter id.*/
 ...
 * @param param_index  Parameter index, or -1 to use param_id.
                               ...
                               uint8_t target_system, uint8_t target_component, const char *param_id, int16_t param_index)
{
    ...
    mav_array_memcpy(packet.param_id, param_id, 16);
 ...
 *
 * @return  Parameter index, or -1 to use param_id.
 */
